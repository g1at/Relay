...
const { POLICY_DEFAULTS, normalizeRuntimePolicy } = require('./sdk-runtime-policy');
const { normalizeSdkPreferences } = require('./sdk-runtime-preferences');
...
function registerGeneralPreferencesIpc({ ipcMain, getWindow, service, dialog, entryFile = path.join(__dirname, 'renderer', 'index.html') }) {
